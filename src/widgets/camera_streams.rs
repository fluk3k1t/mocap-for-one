...
//     pub streams: BTreeMap<String, CameraStream>,
// }

// #[derive(Clone, Serialize, Deserialize, Default)]
// pub struct CameraStreamsConfig {
//     pub streams: BTreeMap<String, VideoSourceConfig>,
// }
...
// impl TryFrom<CameraStreamsConfig> for CameraStreams {
//     type Error = anyhow::Error;

//     fn try_from(config: CameraStreamsConfig) -> Result<Self, Self::Error> {
//         let mut streams = BTreeMap::new();
//         for (name, cfg) in config.streams {
//             let stream = CameraStream::new(cfg).with_context(|| {
//                 format!("failed to restore camera `{name}`")
//             })?;
...
// impl From<&CameraStreams> for CameraStreamsConfig {
//     fn from(streams: &CameraStreams) -> Self {
//         let mut config_map = BTreeMap::new();
//         for (name, stream) in &streams.streams {
//             config_map.insert(name.clone(), stream.video_source_config.clone());
//         }
//         CameraStreamsConfig {
//             streams: config_map,
//         }
...
// impl egui_dock::TabViewer for CameraStreams {
//     type Tab = String;
